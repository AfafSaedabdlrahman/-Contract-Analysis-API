...
1. **Clone the repository**:
    ```bash
    git clone https://github.com/AfafSaedabdlrahman/Contract-Analysis-API.git
    ```
...
To view the output results, including screenshots and JSON files, simply click on the following link:
[**Screenshots and JSON Files**](https://github.com/AfafSaedabdlrahman/-Contract-Analysis-API/tree/main/Screen%20shots%20of%20result).
